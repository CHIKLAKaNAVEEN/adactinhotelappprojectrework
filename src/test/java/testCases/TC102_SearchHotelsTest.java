...
public class TC102_SearchHotelsTest extends BaseClass{
	...
	public void Past_CheckInDate() {
		SearchHotelPage shp=new SearchHotelPage(driver);
		shp.select_Location("Sydney");
		shp.set_checkInDate("20/12/2024");
		shp.click_Search();
	...
	public void CheckOut_Before() {
		SearchHotelPage shp=new SearchHotelPage(driver);
		shp.select_Location("Sydney");
		shp.set_checkInDate("27/12/2024");
		shp.set_checkOutDate("29/12/2024");
		shp.click_Search();
	...
	public void InvalidDate() {
		SearchHotelPage shp=new SearchHotelPage(driver);
		shp.select_Location("Sydney");
		shp.set_checkInDate("35/11/2024");
		shp.set_checkOutDate("7/1/2024");
		shp.click_Search();
